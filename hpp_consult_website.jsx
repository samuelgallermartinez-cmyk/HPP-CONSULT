      ...
      <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="rounded-[2rem] border border-white/10 bg-white/5 p-8">
            ...
            <p className="mt-4 text-slate-300">
              HPP Consult is built for facilities that want more than generic advice. The focus is on real maintenance systems, stronger team capability, improved reliability, and practical results that can be implemented in the field.
            </p>
          </div>
